"""
MiniLM embedding model implementation.
"""
...
class MiniLMModel(EmbeddingModel):
    ...
    This class wraps the sentence-transformers MiniLM model,
    ...
    def __init__(
        ...
        Args:
            model_name: Model name or path (default: all-MiniLM-L6-v2)
        ...
        if lazy_load:
            ...
            self.model = None
            logger.info(
                "MiniLM model initialized (lazy loading)",
                model=model_name,
            ...
            logger.info("MiniLM model initialized", model=model_name, dimension=self.DIMENSION)
